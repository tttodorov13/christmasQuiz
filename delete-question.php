...
<div class="col-md-4 middle-row">
  <div class="form-group">
    ...
    <input type="hidden" class="form-control" readonly>
      <textarea name="question" class="form-control" rows="3" placeholder="Enter question" readonly ><?php echo "$question";?>
      </textarea>
    </input>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="ans1" value="<?php echo "$ans1";?>" readonly>
  </div>
  <div class="form-group">
    <label>2nd answer</label>
    <input type="text" class="form-control" name="ans2"  value="<?php echo "$ans2";?>" readonly>
  </div>
  <div class="form-group">
    <label>3rd answer</label>
    <input type="text" class="form-control" name="ans3"   value="<?php echo "$ans3";?>" readonly>
  </div>
  <div class="form-group">
    <label>4th answer</label>
    <input type="text" class="form-control" name="ans4" value="<?php echo "$ans4";?>" readonly>
  </div>
  <div class="form-group">
